...
def tts_process(generated_script, character_voice, filenameState):
    ...
    # 模拟 TTS 生成过程
    with open('/Users/huang/Desktop/Project/podcast/Voices/merged_lol_data.json', 'r', encoding='utf-8') as f:
    ...
    return "/Users/huang/Desktop/Project/podcast/CosyVoice/result/原著-白话.wav", gr.update(open=True), "TTS 生成成功，请点击播放按钮收听。"
...
音色预览逻辑
"""
VOICES_JSON_PATH = r"/Users/huang/Desktop/Project/podcast/Voices/merged_lol_data.json"
...
with gr.Blocks(theme=gr.themes.Soft(), analytics_enabled=False,
   ...
   """
    btn_generate_script.click(
        ...
        inputs=[pdf_content_display, storyline_json_state, character_json_state],
        outputs=[
    ...
    mode_switcher.change(
        ...
        outputs=[process_status_display]
    )
