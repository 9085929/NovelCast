...
class CosyVoiceFrontEnd:
    ...
    def __init__(self,
        ...
        if self.use_ttsfrd:
            ...
            ttsfrd_path = '/home/qzh/data_hdd/home/qzh/qzh/KGW/CosyVoice-main/CosyVoice-main/pretrained_models/CosyVoice-ttsfrd/resource'
            assert self.frd.initialize(ttsfrd_path) is True, 'failed to initialize ttsfrd resource'
